<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FoodReservation.Admin.Product" %>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FoodieDBConnectionString2 %>"
                                                            ProviderName="<%$ ConnectionStrings:FoodieDBConnectionString2.ProviderName %>" SelectCommand="SELECT [CategoryID], [Name] FROM [Categories]"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="pb-5">
                                                    <asp:Button ID="btnAdOrUpdate" runat="server" Text="Add" CssClass="btn btn-primary"
                                                        OnClick="btnAdOrUpdate_Click" />
                                                    &nbsp;

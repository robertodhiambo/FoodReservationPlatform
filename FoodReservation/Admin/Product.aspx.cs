...
namespace FoodReservation.Admin
{
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void btnAdOrUpdate_Click ( object sender , EventArgs e )
        {
        ...
        protected void rProduct_ItemCommand ( object source , RepeaterCommandEventArgs e )
        {
            ...
            else if ( e.CommandName == "delete" )
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery ( );
                    lblMsg.Visible = true;
                    lblMsg.Text = "'Category deleted successfuly";
                    lblMsg.CssClass = "alert alert-danger";
                    getProducts ( );
                }
                catch ( Exception ex )

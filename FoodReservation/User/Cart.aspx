<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="FoodReservation.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                        <tr>
                            ...
                            <td>Ksh.<asp:Label ID="lblPrice" runat="server" Text='<%# Eval ("Price") %>'></asp:Label>
                            ...
                            <td>Ksh.<asp:Label ID="lblTotalPrice" runat="server"></asp:Label></td>
                            <td>
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td>Ksh.<% Response.Write ( Session ["grandTotalPrice"] ); %></td>
                        <td></td>
                    </tr>
                    <tr>

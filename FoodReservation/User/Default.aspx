<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="FoodReservation.User.Default" %>
<% @Import Namespace ="FoodReservation" %>
                ...
                <div class="owl-carousel client_owl-carousel">
                    <div class="item">
                        <div class="box">
                            <div class="detail-box">
                                <p>
                                    Amazing food and super-fast delivery! The ordering process was smooth, and my meal arrived hot and fresh. Definitely ordering again!
                                </p>
                                <h6>Alice Mwapo
                                </h6>
                            ...
                            <div class="img-box">
                                <img src="../TemplateFiles/images/alice.jpg" alt="" class="box-img">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="box">
                            <div class="detail-box">
                                <p>
                                   Great variety of dishes and reasonable prices. The flavors were fantastic, but the delivery took a bit longer than expected.
                                </p>
                                <h6>Rither Ndolo
                                </h6>
                            ...
                            <div class="img-box">
                                <img src="../TemplateFiles/images/rither.jpg" alt="" class="box-img">
                            </div>
                        </div>
                    </div>
                </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="FoodReservation.User.Invoice" %>
            ...
            <asp:Repeater ID="rOrderItem" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <%# string.IsNullOrEmpty( Eval ("Price").ToString() )  ? "" : "Ksh." + Eval("Price") %>
                        </td>
                        <td>
                            <%# Eval ("Quantity") %>
                        </td>

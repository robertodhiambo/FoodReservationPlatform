<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="FoodReservation.User.Menu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    function filterProducts(categoryId) {
        window.location.href = "Menu.aspx?categoryId=" + categoryId;
    }
    </script>
